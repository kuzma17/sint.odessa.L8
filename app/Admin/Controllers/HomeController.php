    ...
    public function index__()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->row(function ($row) {
                ...
                $row->column(3, new InfoBox('Всего клиентов', 'users', 'yellow', '/admin/users', \App\Models\User::count() ));
                $row->column(3, new InfoBox('Всего заказов', 'shopping-cart', 'red', '/admin/orders', \App\Models\Order::count()));
            });
